...
const projects = [
  {
    ...
    description: 'Este é o meu portfólio pessoal, desenvolvido para apresentar minhas habilidades, projetos e informações de contato.',
    tech: ['React', 'TypeScript', 'Tailwind CSS'],
    image: 'https://images.pexels.com/photos/546819/pexels-photo-546819.jpeg?auto=compress&cs=tinysrgb&w=800',
    github: 'https://github.com/RafaelFrancoD/portfolio-pessoal',
    liveDemo: 'https://rafaelfrancod.github.io/portfolio-pessoal/' // Placeholder: Atualizar com o link real da demo
  },
  {
...
const ProjectsSection: React.FC = () => {
  return (
    <section id="projects" className="py-24 px-6 bg-gradient-to-br from-black to-blue-900 rounded-lg">
