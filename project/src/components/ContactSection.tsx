      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-4 sm:gap-8 w-full max-w-6xl mx-auto">
          <div className="flex flex-col gap-4 w-full">
            ...
            <a href="https://wa.me/5517992256180" target="_blank" rel="noopener noreferrer" data-gsap-item className="block bg-black/30 backdrop-blur-sm rounded-lg p-4 sm:p-6 border border-emerald-500/15 flex items-start gap-4 transition-all duration-300 hover:border-emerald-400/50 hover:transform hover:scale-105">
              <div className="bg-slate-900 p-3 rounded-full flex-shrink-0">
